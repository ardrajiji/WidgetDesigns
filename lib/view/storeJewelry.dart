...
import 'package:flutter_project/view/services/jewelryService.dart';
import 'package:flutter_project/view/store.dart';

class StoreJewelry extends StatelessWidget {
 const StoreJewelry({super.key});
